...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append('speciality', newSpeciality || speciality);
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            <div className='flex-1 flex flex-col gap-1'>
              ...
              <input onChange={(e) => setNewSpeciality(e.target.value)} value={newSpeciality} className='border rounded px-3 py-2 mt-2' type="text" placeholder='Add new speciality' />
            </div>
            <div className='flex-1 flex flex-col gap-1'>
              <p>Education</p>
