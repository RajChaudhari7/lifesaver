  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-5 gap-4 gap-y-6'>
          {filterDoc.map((item, index) => (
            ...
            >
              ...
              <div className='p-4'>
                <div className={`flex items-center gap-4 text-sm text-center ${item.available ? 'text-green-500' : 'text-red-500'}`}>
